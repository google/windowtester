...
public abstract class MacCocoa implements MacExtensions {
	...
	static final int kCFAllocatorDefault = 0;
	static final String kAXChildrenAttribute = "AXChildren";
	static final String kAXPositionAttribute = "AXPosition";
	static final String kAXSizeAttribute = "AXSize";
	 ...
	 * 
	 */
	static void fixMenuBarFontSize() {
	 ...
	 */
	static boolean isMenuBarItem(MenuItem item) {
	 ...
	 */
	void getMenuBarVisualData(Menu menu, List bounds) {
