...
package com.windowtester.test.gef;
...
public class GEFTestPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.windowtester.test.gef";

	// The shared instance
	private static GEFTestPlugin singleton;
	 ...
	 */
	public static GEFTestPlugin getDefault() {
		return singleton;
	}
	...
	//////////////////////////////////////////////
	// The Logic GEF had a LogicPlugin GEFTestPlugin, it has been placed here
	//////////////////////////////////////////////
