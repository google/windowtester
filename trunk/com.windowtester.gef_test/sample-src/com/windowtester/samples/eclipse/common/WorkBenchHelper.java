package com.windowtester.samples.eclipse.common;
...
public class WorkBenchHelper {
     ...
     */
    public static void createSimpleProject(IUIContext ui, String projectName) 
     ...
     */
    public static void openView(IUIContext ui, View type) throws WidgetSearchException
    {
        TestCase.assertNotNull(ui);
     ...
     *    condition to be met
     */
    public static void waitForProjectExists(IUIContext ui, 
                                     String projectName,
                                     boolean exists)
    {
