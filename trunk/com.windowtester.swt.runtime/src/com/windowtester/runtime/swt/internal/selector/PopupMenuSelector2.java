...
//    }
	...
	{
		MenuItemReference menuItemRef = new MenuDriver().resolveAndSelect(new Callable<MenuReference>() {
			public MenuReference call() throws Exception {
				return showContextMenu(clickLocation);
			}
		}, menuItemPath);
		return menuItemRef.getWidget();
...
//    	}
	...
	private MenuReference showContextMenu(final ClickLocation clickLocation) {
    	SWTLocation location = clickLocation.asSWTLocation();
