...
/**
 * Locates labeled {@link Label} widgets.
 * @see LabeledLocator
 */
public class LabeledLabelLocator extends LabeledLocator
	implements HasText, HasFocus
{

	private static final long serialVersionUID = -6520253201485822945L;

	/**
	 * Create a locator instance.
	 * @param labelText the text of the label to match
	 */	
	public LabeledLabelLocator(String labelText) {
		super(Label.class, labelText);
	}
	 ...
	 */
	public LabeledLabelLocator(String labelText, int index, SWTWidgetLocator parentLocator) {
		super(Label.class, labelText, index, parentLocator);
	}
	 ...
	 * @param parent the parent locator
	 */
	public LabeledLabelLocator(String labelText, SWTWidgetLocator parentLocator) {
		super(Label.class, labelText, parentLocator);
	}
