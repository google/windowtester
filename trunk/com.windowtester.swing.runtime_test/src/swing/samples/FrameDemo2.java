...
/*
 * FrameDemo2.java is a 1.4 application that shows off the window
 * decoration features added in 1.4, plus some window positioning
 * code and (optionally) setIconImage. It uses the file
 * images/FD.jpg.
 */
