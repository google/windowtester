...
/**
 * A factory for creating instances of SWT widget references specific to macosx cocoa.
 */
public class WTRuntimeFactorySWT_cocoa_x86 extends WTRuntimeFactorySWT {
	
	@Override
	public IWidgetReference createReference(Object widget) {
		if (widget instanceof MenuItem)
			return new MenuItemReference_cocoa_x86((MenuItem)widget);
