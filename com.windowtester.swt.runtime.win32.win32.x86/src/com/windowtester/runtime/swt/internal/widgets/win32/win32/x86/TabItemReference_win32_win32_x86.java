...
/**
 * A {@link TabItem} reference that uses native win32_x86-specific code to access bounds.
 */
public class TabItemReference_win32_win32_x86 extends TabItemReference {

	public TabItemReference_win32_win32_x86(TabItem control) {
		super(control);
	}
	...
	public Rectangle getDisplayBounds() {
		return displayRef.execute(new Callable<Rectangle>() {
			public Rectangle call() throws Exception {
				...
				int [] rect = new int [4];
				Win32.SendMessage (parent, /*TCM_GETITEMRECT*/ 0x130a, index, rect);
