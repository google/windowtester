...
public class ProgramArgumentBuilder36 {

	private HashSet locations;
	
	public ProgramArgumentBuilder36(HashSet locations){
	...
	private void validateFeatures() throws CoreException {
		...
		if (badStructure) {
			throw new CoreException(LauncherUtils.createErrorStatus(
					"When in feature mode, plug-ins must be in the 'plugins' directory and features in 'features' directory in the workspace."));
			// in 3.6 could not find
			//PDEUIMessages.WorkbenchLauncherConfigurationDelegate_badFeatureSetup));
		}
