 ...
 */
class InspectorPopupDriver {

	
	public static void main(String[] args) {
		InspectorPopup popup = (InspectorPopup)DisplayExec.sync(new RunnableWithResult(){
			public Object runWithResult() {
				InspectorPopup inspectorPopup = new InspectorPopup(new Shell(SWT.ON_TOP), createWidgetDescription());
				inspectorPopup.open();
		...
		return new IWidgetDescription() {
			...
			public PropertySet getProperties() {
				return new PropertySet.TestStub().
					...
					withMapping(PropertyMapping.TEXT.withValue("innagoddadavida"));
			}
