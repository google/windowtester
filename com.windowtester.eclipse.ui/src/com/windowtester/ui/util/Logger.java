...
public class Logger
{
	...
	public static IStatus createLogStatus(String message, Object detail, String defaultMessage) {
		...
		if (detail instanceof Throwable)
			return new Status(Status.ERROR, UiPlugin.PRODUCT_ID, Status.OK, text, (Throwable) detail);
		if (detail instanceof IStatus)
			return new MultiStatus(UiPlugin.PRODUCT_ID, Status.OK, new IStatus[]{
				(IStatus) detail
			}, message, null);
		if (detail == null)
			return new Status(Status.INFO, UiPlugin.PRODUCT_ID, Status.OK, text, null);
		...
		return new Status(Status.INFO, UiPlugin.PRODUCT_ID, Status.OK, buf.toString(), null);
	}
