 ...
 *******************************************************************************/
public class ModifyCompilerSettingsTest extends BaseTest {
...
//							return TextMatcher.create("Use compliance .*").matches(link);
	...
	public void testToggleCompilerSettings() throws Exception {
		...
		// note that combo selection is self-verifying
		//setCompilerSettings(projectName, "5.0");
		//TODO: we should poll these items dynamically...
		//the issue is that sometime we see 5.0 vs. 1.5
	}
