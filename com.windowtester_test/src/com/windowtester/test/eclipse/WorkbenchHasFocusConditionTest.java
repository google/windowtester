 ...
 *******************************************************************************/
public class WorkbenchHasFocusConditionTest extends UITestCaseSWT {
...
//		int modifier = Platform.isOSX() ? WT.COMMAND : WT.ALT;
//		getUI().keyClick(modifier | WT.TAB);
		UIDriver driver = new UIDriver();
		driver.click(ShellFinder.getActiveShell(Display.getDefault()), -10, 0);
	}
