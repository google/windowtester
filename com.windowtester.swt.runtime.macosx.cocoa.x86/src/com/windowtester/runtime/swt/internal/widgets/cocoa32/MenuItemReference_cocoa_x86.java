 ...
 */
public class MenuItemReference_cocoa_x86 extends MenuItemReference {

	public MenuItemReference_cocoa_x86(MenuItem item) {
		super(item);
	}

	@Override
	public Rectangle getDisplayBounds() {
		return Cocoa32.INSTANCE.getMenuItemBounds(getWidget());
	}
