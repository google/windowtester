 ...
 */
public class Win32_64
{
	static long SendMessage(Control target, int Msg, long wParam, int[] lParam) {
		try {
			Field field = Control.class.getDeclaredField("handle");
			field.setAccessible(true);
			Object handle = field.get(target);
			return OS.SendMessage(((Long) handle).longValue(), Msg, wParam, lParam);
		}
		catch (Exception e) {
