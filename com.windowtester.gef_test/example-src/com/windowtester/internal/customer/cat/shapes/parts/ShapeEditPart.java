...
import com.windowtester.internal.customer.cat.shapes.model.EllipticalShape;
import com.windowtester.internal.customer.cat.shapes.model.ModelElement;
import com.windowtester.internal.customer.cat.shapes.model.RectangularShape;
import com.windowtester.internal.customer.cat.shapes.model.Shape;
import com.windowtester.internal.customer.cat.shapes.model.commands.ConnectionCreateCommand;
import com.windowtester.internal.customer.cat.shapes.model.commands.ConnectionReconnectCommand;
...
public class ShapeEditPart extends AbstractGraphicalEditPart implements
	...
	private IFigure createFigureForModel() {
		if (getModel() instanceof EllipticalShape) {
			MyEllipse ellipse = new MyEllipse("Ellipse " + counter);
			counter++;
			return ellipse;
		} else if (getModel() instanceof RectangularShape) {
			MyRectangle rectangle = new MyRectangle("Rectangle " + counter);
			counter++;
			return rectangle;
		} else {
