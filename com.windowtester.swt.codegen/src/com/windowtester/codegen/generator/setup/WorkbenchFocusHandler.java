...
/**
 * A handler to ensure Workbench focus.
 */
public class WorkbenchFocusHandler extends SetupHandler {
	...
	public String getBody() {
		return "ui.ensureThat(new WorkbenchLocator().hasFocus());";
	}
	...
	public String getStaticBody() {
		return "ui.ensureThat(workbench().hasFocus());";
	}
	...
	public String getDescription() {
		return "Workbench has keyboard focus";
	}
