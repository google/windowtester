 ...
 * 
 * NOTE: *DOES MATCH ON TEXT VALUES*
 * 
 */
public class TextMatcher2 extends ClassMatcher {
  ...
  private final Class clazz;
     ...
     */
    public TextMatcher2(String text) {
     ...
     */
    public TextMatcher2(String text, boolean mustBeShowing) {
     ...
     */
    public TextMatcher2(String text, Class clazz) {
     ...
     * @param clazz the class to match.
     */
    public TextMatcher2(String text, boolean mustBeShowing, Class clazz) {
    	super(clazz);
    	this.clazz = clazz;
    	this.text = text;
