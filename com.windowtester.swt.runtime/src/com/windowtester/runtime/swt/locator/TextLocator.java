...
/**
 * Locates {@link Text} widgets.
 */
public class TextLocator extends SWTWidgetLocator
	implements IsEnabled, HasText, HasFocus
{
	...
	public TextLocator(SWTWidgetLocator parent) {
		super(Text.class, parent);
	}
	 ...
	 * @param parent the parent locator	 
	 */
	public TextLocator(int index, SWTWidgetLocator parent) {
		super(Text.class, index, parent);
	}
