...
import com.windowtester.runtime.swt.internal.commands.eclipse.ClosePerspectiveCommand;
import com.windowtester.runtime.swt.locator.eclipse.PerspectiveLocator;

/**
 * A condition handler for ensuring that perspectives are closed.
 */
public class PerspectiveClosedConditionHandler extends UICondition implements IUIConditionHandler {

	public static PerspectiveClosedConditionHandler forPerspective(PerspectiveLocator perspective) {
		return new PerspectiveClosedConditionHandler(perspective);
	}

	private final PerspectiveLocator perspective;

	private PerspectiveClosedConditionHandler(PerspectiveLocator perspective) {
	...
	public void handle(IUIContext ui) throws Exception {
		ClosePerspectiveCommand.forPerspective(perspective).run();
	}
	...
	public boolean testUI(IUIContext ui) {
		return perspective.isActive(false).test();
	}
