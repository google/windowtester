...
public class EclipsePlugin extends AbstractUIPlugin {
	...
	public ResourceBundle getResourceBundle() {
		try {
			if (resourceBundle == null)
				resourceBundle = ResourceBundle.getBundle("abbot.swt.eclipse.EclipsePluginResources");
	...
	public static ImageDescriptor getImageDescriptor(String path) {
		return AbstractUIPlugin.imageDescriptorFromPlugin("abbot.swt.eclipse", path);
	}
}
