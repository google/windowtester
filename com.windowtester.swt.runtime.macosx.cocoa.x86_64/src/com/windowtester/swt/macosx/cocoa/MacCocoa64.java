...
import com.windowtester.swt.runtime.internal.macosx.ReflectionUtil;
import com.windowtester.swt.runtime.internal.macosx.cocoa.MacCocoa;
...
public class MacCocoa64 extends MacCocoa {
	...
	static long getID(Widget control, String string) {
		Object fieldObject = ReflectionUtil.getFieldObject(control, string);
		return ReflectionUtil.getFieldLong(fieldObject, "id");
	}
